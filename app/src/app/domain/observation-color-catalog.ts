...
export const CANONICAL_OBSERVATION_COLOR_MAPPINGS = [
  ...
  createObservationColorMapping('Ub', '2-bar outside', 'Headlights', [0, 0, 0], [1, 3, 1]),
  ...
  createObservationColorMapping('Ua', '2-bar outside', 'Headlights', [0, 0, 0], [1, 2, 1]),
  ...
  createObservationColorMapping('Aa', 'None', '2-bar outside', [0, 1, 0], [1, 2, 2]),
  ...
  createObservationColorMapping('Ra', '2-bar outside', 'Headlights', [0, 0, 1], [2, 1, 0]),
  createObservationColorMapping('Ra', 'None', 'None', [0, 3, 2], [3, 1, 0]),
  createObservationColorMapping('Ra', 'None', '2-bar outside', [0, 2, 1], [2, 1, 2]),
  createObservationColorMapping('Rb', '2-bar inside', 'None', [0, 1, 1], [2, 3, 2]),
  createObservationColorMapping('Rb', 'None', 'None', [0, 1, 0], [1, 0, 2]),
  createObservationColorMapping('Rb', 'None', '2-bar outside', [0, 3, 1], [2, 1, 0]),
  ...
  createObservationColorMapping('Na', '2-bar inside', '3-bar', [0, 2, 2], [3, 1, 1]),
  createObservationColorMapping('Nb', '2-bar outside', 'Headlights', [0, 0, 2], [3, 3, 1]),
  ...
  createObservationColorMapping('Gc', 'None', '2-bar inside', [0, 0, 1], [2, 3, 2]),
  createObservationColorMapping('Gd', 'Headlights', 'Headlights', [0, 2, 0], [1, 0, 2]),
  createObservationColorMapping('Gd', 'None', '2-bar outside', [0, 3, 1], [2, 2, 0]),
  createObservationColorMapping('Gd', '2-bar outside', '2-bar outside', [0, 0, 2], [3, 2, 0]),
